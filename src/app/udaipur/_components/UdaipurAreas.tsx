...
const udaipurAreaGroups = [
  {
    region: "Central Udaipur",
    areas: [
      "Lake Palace Road",
      "Fatehpura",
      "Panchwati",
  ...
  {
    region: "Developing & Premium Areas",
    areas: [
      "Bhuwana",
      "Sukher",
      "Bedla",
  ...
  {
    region: "Heritage & Old City Areas",
    areas: [
      "Rampura",
      "Brahmpuri",
      "Ganesh Ghati",
...
export default function UdaipurAreas() {
        ...
        <div className="overflow-hidden rounded-[28px] border border-yellow-100 bg-white/90 shadow-[0_20px_60px_rgba(120,53,15,0.08)] backdrop-blur">
          <div className="px-5 py-6 text-center sm:px-8 md:py-8">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-gray-600 sm:text-base">
              ...
              Udaipur for birthdays, anniversaries, baby showers, proposal
              setups, romantic room decorations, haldi and mehendi decoration.
              We serve major Udaipur areas including Hiran Magri, Fatehpura,
              Saheli Nagar, Bhuwana, Sukher, Pratap Nagar, Lake Palace Road,
              Shobhagpura and nearby localities with same day decoration
              availability.
            </p>

            <button
              type="button"
              aria-controls="udaipur-service-areas"
            ...
            >
              {expanded ? "Hide Areas" : "View Udaipur Areas"}
            </button>
          </div>

          <div
            id="udaipur-service-areas"
