...
import { ahmedabadAreaGroups } from "../areas";

export default function AhmedabadAreas() {
        ...
        <div className="overflow-hidden rounded-[28px] border border-yellow-100 bg-white/90 shadow-[0_20px_60px_rgba(120,53,15,0.08)] backdrop-blur">
          <div className="px-5 py-6 text-center sm:px-8 md:py-8">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-gray-600 sm:text-base">
              ...
              Ahmedabad for birthdays, anniversaries, baby showers, proposal
              setups, romantic room decorations, haldi and mehendi decoration.
              We serve major Ahmedabad areas including SG Highway, Sindhu
              Bhavan Road, Bopal, Satellite, Vastrapur, Navrangpura,
              Maninagar, Naroda, Chandkheda, South Bopal and nearby localities
              with same day decoration availability.
            </p>

            <button
              type="button"
              aria-controls="ahmedabad-service-areas"
            ...
            >
              {expanded ? "Hide Areas" : "View Ahmedabad Areas"}
            </button>
          </div>

          <div
            id="ahmedabad-service-areas"
