...
type CorporateEventsGalleryProps = {
  images: GalleryImage[];
};

export default function CorporateEventsGallery({
  images,
}: CorporateEventsGalleryProps) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Branded event spaces, styled with a professional finish
          </h2>
        </div>
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Show corporate event gallery image ${index + 1}`}
                >
                  <FallbackImage
                    src={image.src}
                    alt={image.alt}
