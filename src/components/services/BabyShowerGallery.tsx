...
type BabyShowerGalleryProps = {
  images: GalleryImage[];
};

export default function BabyShowerGallery({ images }: BabyShowerGalleryProps) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Soft welcome moments, styled with care
          </h2>
        </div>
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Show baby shower gallery image ${index + 1}`}
                >
                  <FallbackImage
                    src={image.src}
                    alt={image.alt}
