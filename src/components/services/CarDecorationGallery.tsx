...
type CarDecorationGalleryProps = {
  images: GalleryImage[];
};

export default function CarDecorationGallery({
  images,
}: CarDecorationGalleryProps) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Car boot surprises, styled for the reveal
          </h2>
        </div>
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Show car decoration gallery image ${index + 1}`}
                >
                  <FallbackImage
                    src={image.src}
                    alt={image.alt}
