...
type RoomDecorationGalleryProps = {
  images: GalleryImage[];
};

export default function RoomDecorationGallery({
  images,
}: RoomDecorationGalleryProps) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Private room surprises, styled for the door-open moment
          </h2>
        </div>
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Show room decoration gallery image ${index + 1}`}
                >
                  <FallbackImage
                    src={image.src}
                    alt={image.alt}
