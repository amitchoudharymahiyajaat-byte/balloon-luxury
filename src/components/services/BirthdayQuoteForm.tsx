...
export default function BirthdayQuoteForm({ cityName }: BirthdayQuoteFormProps) {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const message = `Birthday Decoration Quote Request
...
Message: ${formData.get("message")}`;
    ...
    trackPopupSubmit("birthday_decoration_page");
    trackBookingClick("birthday_decoration_page");
    trackWhatsAppClick("birthday_decoration_quote");
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="flex flex-col gap-3 sm:col-span-2 sm:flex-row">
        ...
        <a
          href="https://wa.me/919602060414?text=Hi%2C%20I%20want%20birthday%20decoration%20details"
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => trackWhatsAppClick("birthday_decoration_contact")}
