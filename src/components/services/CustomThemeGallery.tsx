...
type CustomThemeGalleryProps = {
  images: GalleryImage[];
};

export default function CustomThemeGallery({ images }: CustomThemeGalleryProps) {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Event themes shaped around venues, references and guest flow
          </h2>
        </div>
            ...
            {images.map((image, index) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Show custom theme gallery image ${index + 1}`}
                >
                  <FallbackImage
                    src={image.src}
                    alt={image.alt}
